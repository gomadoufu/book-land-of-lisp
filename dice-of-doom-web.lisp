...
(load (relative->absolute "dice-of-doom-v2.lisp"))
(load (relative->absolute "web-server.lisp"))
(load (relative->absolute "dsl-svg.lisp"))
(load (relative->absolute "macro.lisp"))
